...
begin
  ...
  if cart_items_input is null or jsonb_typeof(cart_items_input) <> 'array' or jsonb_array_length(cart_items_input) = 0 then
  ...
  into resolved_count, distinct_vendor_count, resolved_vendor_id, subtotal_amount
