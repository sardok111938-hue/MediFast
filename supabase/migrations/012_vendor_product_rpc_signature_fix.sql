drop function if exists public.vendor_create_product(text, text, numeric, uuid, text, integer);
...
grant execute on function public.vendor_create_product(uuid, text, text, text, numeric, integer) to authenticated;
